...
| `deploy/test/` | 287 checks across eight suites. Both Workers driven through their real APIs in the real Workers runtime; the node's generated configs parsed and served; and the burn → attribution → replacement → self-heal loop run end to end with real processes. |
